# controller/NotificadorTelegram.py
# ===========================================================================
...
class NotificadorTelegram:
    ...
    async def handle_audio_message(self, audio_file_path: str) -> Optional[str]:
        """
        SOLO transcribe y convierte a comando (NO ejecuta).
        Retorna el comando detectado o None.
        """
        ...
        # ✅ SOLO transcribir y convertir (NO ejecutar)
    ...
    async def execute_command(self, command: str) -> dict:
        ...
        Este método debe ser llamado desde main.py DESPUÉS de validar.
        """
        if not command:
            return {"success": False, "message": "❌ Comando vacío"}
    ...
    async def close_browser(self):
        ...
        await self.executor.browser_manager.close()